...
export default`
### Heartland & ICE
There is strong evidence of a close relationship and regular collaboration between Heartland Alliance and ICE. For example, Heartland’s public job postings explicitly advertise collaboration with ICE as an essential duty: A “Swing Shift Mental Health Clinical Practitioner - Unaccompanied Children's Programs […] Collaborates and serves as a primary contact for the Federal Field Specialist, the DUCS Field Coordinator and the Immigration and Customs Enforcement department as well as other voluntary agencies.” ProPublica reports: “As caseworkers try to find placements, the older teens live in fear of turning 18. Records show that immigration officials, almost without fail, arrive on the children’s birthdays to take them into custody.” Crucially, in 2016, a Memorandum of Agreement (MOA) between DHS/ICE and ORR established information sharing between the agencies. Heartland has complied with these directives, which include fingerprinting sponsors and investigating their immigration status. This collaboration with ICE puts children and families in direct and urgent danger.
